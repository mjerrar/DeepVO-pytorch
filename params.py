...
class Parameters():
	def __init__(self):
		self.n_processors = 8
		# Path
		self.data_dir =  '/home/vendetta/DeepVO/DeepVO-pytorch/KITTI'
		...
		self.load_model_path = '/home/vendetta/DeepVO/DeepVO-pytorch/models/t000102050809_v04060710_im184x608_s5x7_b8_rnn1000_optAdagrad_lr0.0005.model.train'
		#'models/t{}_v{}_im{}x{}_s{}x{}_b{}_rnn{}_{}.model{}'.format(''.join(self.train_video), ''.join(self.valid_video), self.img_h, self.img_w, self.seq_len[0], self.seq_len[1], self.batch_size, self.rnn_hidden_size, '_'.join([k+str(v) for k, v in self.optim.items()]), self.resume_t_or_v)
